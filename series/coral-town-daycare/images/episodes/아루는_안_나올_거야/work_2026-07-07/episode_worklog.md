# Episode Worklog - 아루는 안 나올 거야

## Source

- Downloaded local source: `C:/Users/USER/Downloads/aru_transition_story_prompts_revised.md`
- Series script copy: `series/coral-town-daycare/docs/episodes/아루는_안_나올_거야.md`
- Rulebook: `series/coral-town-daycare/docs/산호마을_어린이집_이미지_규칙서.md`
- Page plan: `series/coral-town-daycare/images/episodes/아루는_안_나올_거야/work_2026-07-07/page_plan.md`
- Reference asset plan: `series/coral-town-daycare/images/episodes/아루는_안_나올_거야/work_2026-07-07/reference_assets/reference_asset_plan.md`
- Work root: `series/coral-town-daycare/images/episodes/아루는_안_나올_거야/work_2026-07-07`
- Final folder: `series/coral-town-daycare/images/episodes/아루는_안_나올_거야/final`

## Script Intake - 2026-07-07

- File title: `aru_transition_story_prompts_revised.md`
- Episode title: `아루는 안 나올 거야`
- Subtitle: `바뀌는 건 어렵지만, 해보면 괜찮아`
- Structure: cover + 12 story pages.
- Core story: Aru resists stopping mud play, discovers washing/water play is also pleasant, then resists leaving the water. Aru realizes the hard part is changing states, not the activities themselves.
...
- No-bag derived references available and useful for this episode:
  - `series/coral-town-daycare/references/characters/no_bag/*.png`
- Missing required reference:
  - shallow shell water tub / safe washing-water-play space.
- Required missing asset plan:
  - `work_2026-07-07/reference_assets/reference_asset_plan.md`
...
- Aru's stubbornness is not bad behavior. It is transition resistance and self-protection.
- Mari teacher does not scold, drag, grab, force, or shame Aru.
- Aru must never gain hands, feet, legs, arms, a human torso, or a separate lower body.
- All yard, mud-play, washing, and water-play pages omit school bags on children.
- Water-play scenes must be shallow, clean, warm, safe, and bright.
- The page 09 realization belongs to Aru. Do not visually make Mari the one revealing the lesson first.
- Korean text must be exact and readable.

## Preparation Status

- Script copied into series docs:
  - `series/coral-town-daycare/docs/episodes/아루는_안_나올_거야.md`
- Work folder created:
  - `series/coral-town-daycare/images/episodes/아루는_안_나올_거야/work_2026-07-07`
- Final folder created:
  - `series/coral-town-daycare/images/episodes/아루는_안_나올_거야/final`
- Page plan prepared:
  - `work_2026-07-07/page_plan.md`
- Reference asset plan prepared:
  - `work_2026-07-07/reference_assets/reference_asset_plan.md`
- Batch 1 prompt plan prepared:
  - `work_2026-07-07/batch_1/batch_1_prompt_plan.md`
- Generation status:
  - Reference setup accepted by user.
  - Main story pages not started.
  - Batch 1 prepared for generation.

## Reference Asset Generation - 2026-07-07

- Generated:
  - `work_2026-07-07/reference_assets/shallow_shell_water_tub_ref.png`
- Default generated source kept in place:
  - `C:/Users/USER/.codex/generated_images/019f3a91-0b9e-7422-b6ba-74ddfa0eaafd/ig_0d47dc3ebd7c6f59016a4c70f46cd0819bab8a58669229faae.png`
- Technical verification:
  - Workspace copy exists.
  - Image size: `1536 x 1024`.
- QA:
  - Status: `user approved` for reference setup.
  - No characters, labels, signs, pseudo-writing, or readable text.
  - Main front three-quarter view plus smaller side view match the same low shell basin design.
  - The style matches Coral Town Daycare's soft watercolor, colored-pencil, low-saturation pastel look.
  - Carry-forward lock: in page prompts, describe this as a shallow toddler-safe shell tub with warm water; do not let page generations reinterpret it as a deep pool, metal bathtub, sink, or bathroom fixture.

## Batch 1 Preparation - 2026-07-07

- User response to shell tub reference: `괜찮네`.
- Batch 1 scope:
  - Cover: Aru in the approved shallow shell tub with Banguli.
  - Page 01: Aru enjoying mud play with Mongle and Tori nearby.
  - Page 02: Mari announces washing time; Aru freezes.
  - Page 03: Aru refuses washing with cute defensive transition resistance.
- Required references checked and present:
  - `work_2026-07-07/reference_assets/shallow_shell_water_tub_ref.png`
  - `series/coral-town-daycare/references/배경_전경과_놀이터.png`
  - `series/coral-town-daycare/references/locations/산호_터널_레퍼런스.png`
  ...
  - original official references for Aru, Mari teacher, Banguli, Mongle, and Tori.
- Batch 1 prompt plan updated:
  - `work_2026-07-07/batch_1/batch_1_prompt_plan.md`
- Generation order:
...
- Stop after these four candidates for QA before any final promotion or Batch 2 work.

## Batch 1 Generation - 2026-07-07

- User instruction: start Batch 1.
- Scope generated: cover + pages 01-03.
- Extra reference alias created for reliable local viewing/loading:
  - `work_2026-07-07/reference_assets/aru_no_bag_ref.png`
- Generated sources retained under default imagegen folder:
  - Cover source: `C:/Users/USER/.codex/generated_images/019f3a91-0b9e-7422-b6ba-74ddfa0eaafd/ig_0f1c4914f0a4e065016a4c736c59548199b044fac7a58e6ed9.png`
  - Page 01 source: `C:/Users/USER/.codex/generated_images/019f3a91-0b9e-7422-b6ba-74ddfa0eaafd/ig_030beb7114e6acd1016a4c75143be8819186f1dbfe79ac2b35.png`
  - Page 02 source: `C:/Users/USER/.codex/generated_images/019f3a91-0b9e-7422-b6ba-74ddfa0eaafd/ig_004b2adb583d5dca016a4c7678f4f48191b281e12fc5dfa918.png`
  - Page 03 art source: `C:/Users/USER/.codex/generated_images/019f3a91-0b9e-7422-b6ba-74ddfa0eaafd/ig_028937c35daf754c016a4c78489fe48191b056d3504fddff49.png`
  - Page 03 model text-repair attempt: `C:/Users/USER/.codex/generated_images/019f3a91-0b9e-7422-b6ba-74ddfa0eaafd/ig_0fa978388c63629f016a4c79d90da88191a1d79adb97d948d3.png`

### Saved Batch 1 Candidates

- `batch_1/00_cover_candidate_v1.png`
  - Status: `hold`.
  - QA: art is strong; Aru remains pufferfish-only with no limbs; shell tub and Banguli read well.
  - Text issue: subtitle generated as a near-miss, so it should not be promoted as-is.
- `batch_1/00_cover_candidate_v2_local_subtitle_fix.png`
  - Status: `superseded`.
  - QA: subtitle text was repaired, but a faint older subtitle remnant remained.
- `batch_1/00_cover_candidate_v3_local_subtitle_fix.png`
  - Status: `candidate pass`.
  - QA: preferred cover candidate for Batch 1 review. Subtitle repaired with local text panel. Text is exact; panel is cleaner/flatter than the generated watercolor texture.
- `batch_1/01_candidate_text_v1.png`
  - Status: `candidate pass`.
  - QA: Aru has no hands/feet/legs/body; mud is warm and playful; Mongle, Tori, and Banguli are recognizable; no body-worn bags seen. Text appears correct and readable.
- `batch_1/02_candidate_text_v1.png`
  - Status: `candidate pass`.
  - QA: Aru freeze reaction reads gentle, not angry; Mari is warm and non-forcing; background friends are small and not shaming. Text appears correct and readable.
- `batch_1/03_candidate_text_v1_hold_text.png`
  - Status: `hold`.
  - QA: art, posture, Mari, and Banguli are strong, but the first quote missed `안` in `안 씻을래!`.
- `batch_1/03_candidate_text_v2_local_text_panel.png`
  - Status: `candidate pass`.
  - QA: preferred page 03 candidate for Batch 1 review. The exact Korean text is repaired locally. Character/art QA remains good; panel edge is visibly cleaner/flatter than generated watercolor texture.
...
- Safety/tone: pass for review. Mud is cute and pastel; Mari does not scold, grab, drag, or force.
- Contamination: no old-episode visual contamination noticed in the preferred candidates.
- Text: pages 01-02 appear generated correctly; cover and page 03 required local text-panel repair before review.
- Final promotion: none. Batch 1 files are candidates only until user approval.

## Batch 1 Targeted Rework - 2026-07-07

- User QA:
  - Cover/page 01/page 02 Aru was too saturated orange.
  - Cover/page 01/page 02 scarf was blue; it should match page 03/official Aru's red-white scarf.
  - Page 01 had duplicate Mongle and Tori: foreground playing versions plus background back-facing versions. The background walking-away versions should not appear on page 01.
  - User noted the cover subtitle was acceptable, so subtitle texture is not the active concern for this pass.
- New color lock:
  - Use page 03 Aru as the in-episode color reference: soft cream-yellow body, muted tan-olive top shading, darker brown top spots, warm beige fins, red-white sailor scarf.
  - Avoid saturated orange Aru and blue scarf in all Batch 1 pages.

### Rework Outputs

- `batch_1/00_cover_candidate_v4_aru_color_raw.png`
  - Source: `C:/Users/USER/.codex/generated_images/019f3a91-0b9e-7422-b6ba-74ddfa0eaafd/ig_02759dda35c7a6d1016a4c8385bc508191bba539d7c4e6f677.png`
  - Status: `candidate pass`.
  - QA: Aru color and scarf now match the page 03/official lock much more closely. Title/tub/Banguli composition preserved. Subtitle remains in the generated style and was accepted as not the active issue.
- `batch_1/00_cover_candidate_v5_aru_color_subtitle_fix.png`
  - Status: `alternate candidate`.
  - QA: same cover color repair with local exact subtitle panel. Keep as text-exact alternate if needed, but not the active user-requested change.
- `batch_1/01_candidate_text_v2_aru_color_scarf_fix.png`
  - Source: `C:/Users/USER/.codex/generated_images/019f3a91-0b9e-7422-b6ba-74ddfa0eaafd/ig_0e8db1501b29c306016a4c882404d48191a67c15ee45c69d8c.png`
  - Status: `hold`.
  - QA: Aru color and scarf improved, but background back-facing Mongle and Tori created a duplicate-character story error.
- `batch_1/01_candidate_text_v3_aru_color_no_background_duplicates.png`
  - Source: `C:/Users/USER/.codex/generated_images/019f3a91-0b9e-7422-b6ba-74ddfa0eaafd/ig_0714e87de2cf5b9f016a4c903077bc8191a5931a54b6ccda36.png`
  - Status: `candidate pass`.
  - QA: preferred page 01 candidate. Aru color/scarf corrected; only the foreground playing Mongle and Tori remain; background walking-away duplicates removed.
- `batch_1/02_candidate_text_v2_aru_color_scarf_fix.png`
  - Source: `C:/Users/USER/.codex/generated_images/019f3a91-0b9e-7422-b6ba-74ddfa0eaafd/ig_0ed8cd29ab926492016a4c8c094a0c819195ff783c7673ba5e.png`
  - Status: `candidate pass`.
  - QA: Aru color/scarf corrected. Background friends walking toward washing remain acceptable on page 02 because the script says friends begin going to wash.

## Previous Batch 1 Gate - Completed 2026-07-07

1. User reviews Batch 1 preferred candidates:
   - `batch_1/00_cover_candidate_v4_aru_color_raw.png`
   - `batch_1/01_candidate_text_v3_aru_color_no_background_duplicates.png`
   - `batch_1/02_candidate_text_v2_aru_color_scarf_fix.png`
   - `batch_1/03_candidate_text_v2_local_text_panel.png`
2. If approved, promote approved files into `final` with stable page filenames.
3. If user wants polish, retry only the smallest failing unit: cover subtitle panel, page 03 text panel, or a single page image.
4. Do not start Batch 2 until Batch 1 is approved, rejected, or targeted for retries.

## Batch 1 Final Promotion - 2026-07-07

- User approval: `모두 좋다`.
- Promoted to final:
  - `final/00_표지.png` from `batch_1/00_cover_candidate_v4_aru_color_raw.png`
  - `final/01_진흙놀이.png` from `batch_1/01_candidate_text_v3_aru_color_no_background_duplicates.png`
  - `final/02_씻을_시간.png` from `batch_1/02_candidate_text_v2_aru_color_scarf_fix.png`
  - `final/03_안_씻을래.png` from `batch_1/03_candidate_text_v2_local_text_panel.png`
- Status: `final promoted` for cover + pages 01-03.
- Carry-forward locks:
  - Use final page 03 as the approved in-episode Aru color/scarf lock.
  - Keep Aru soft cream-yellow/tan-olive with darker brown top spots and red-white scarf.
  - Avoid saturated orange Aru and blue scarf.
  - Page 01 duplicate lock remains active: no duplicate back-facing background copies of the same friends in one page.

## Batch 2 Preparation - 2026-07-07

- Batch 2 scope:
  - `04_candidate_text_v1.png`: Mari validates that stopping a fun activity is hard; Aru's spikes soften.
  - `05_candidate_text_v1.png`: Banguli first enters the warm shallow shell tub while Aru hesitates outside.
  - `06_candidate_text_v1.png`: Aru enters warm water, mud washes off, and the spikes relax.
- Batch 2 prompt plan prepared:
  - `work_2026-07-07/batch_2/batch_2_prompt_plan.md`
- Required references:
  - official exterior/playground for page 04.
  - approved shallow shell water tub reference for pages 05-06.
  - official no-bag and original references for Aru, Mari teacher, and Banguli as visible.
